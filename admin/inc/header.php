...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
			...
			<li class="nav-item">
				<a class="nav-link" href="#" data-toggle="collapse" data-target="#collapseConteudo" aria-expanded="true" aria-controls="collapseConteudo">
					<i class="fas fa-fw fa-folder"></i>
					<span>Conteúdo</span>
				</a>
				<div id="collapseConteudo" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						<h6 class="collapse-header">O que você deseja:</h6>
			...
			<li class="nav-item">
				...
				<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						<h6 class="collapse-header">O que você deseja:</h6>
						<a class="collapse-item" href="l">Buttons</a>
			...
			<!-- Nav Item - Pages Collapse Menu -->
			<li class="nav-item">
				<a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseUserAdm" aria-expanded="true" aria-controls="collapseUserAdm">
					<i class="fas fa-fw fa-users"></i>
					<span>Usuários administrativos</span>
				</a>
				<div id="collapseUserAdm" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						<h6 class="collapse-header">O que você deseja:</h6>
		...
		<div id="content">
            ...
            <li class="nav-item dropdown no-arrow">
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                <a class="dropdown-item" href="editar_usuario.php?id=<?=$user["id"]?>">
